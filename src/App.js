...
function App() {
  ...
  return (
    <div className={`App ${libraryStatus ? "library-active":""}`}>
      ...
      <Player audioRef={audioRef} setIsPlaying={setIsPlaying} isPlaying={isPlaying} currentSong={currentSong} setSongInfo={setSongInfo} songInfo={songInfo} setSongs={setSongs} songs={songs} setCurrentSong={setCurrentSong} />
